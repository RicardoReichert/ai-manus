<template>
  <!-- Trimmed adaptation of ComputerPanelContent.vue: header + Terminal/Tools tabs.
       (Screen/VNC and Agent tabs were removed — see AGENTS.md history/commit
       log for context: they didn't give a reliable real-time view.) -->
  <div
...
export type ClawComputerViewMode = 'terminal' | 'tools';
...
const viewMode = ref<ClawComputerViewMode>('tools');
